...
" Source code version control 
  ...
  Plug 'rbong/vim-flog'                         " Git Graph View
call plug#end()
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" => Plugin Setting
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
" Highlight C variables
" syn clear
" autocmd BufRead,BufNewFile *.c,*.cpp,*.h,*.hpp syn match cVariable "\<[a-zA-Z_]\w*\>"
" hi def link cVariable Identifier
" " Highlight C variables in C and C++ files
" autocmd BufRead,BufNewFile *.c,*.cpp,*.h,*.hpp syn match cVariable "\<\h\w*\>" contained
" hi def link cVariable Identifier
" " Highlight C variables
" syn match cVariable "\<\h\w*\>" contains=ALLBUT,cCppOutIf,cCppOutElse,cCppInIf,cCppInElse,cCppOutSkip,cCppInSkip,cSpecial,cFormat,cComment,@Spell
" hi def link cVariable		Comment
" " Highlight C variables
" augroup cVariableHighlight
"   autocmd!
"   autocmd FileType c,cpp,objc highlight link cVariable Identifier
"   autocmd FileType c,cpp,objc syn match cVariable "\<\h\w*\>"
" augroup END
